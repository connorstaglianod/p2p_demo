...
Ensure the file intended for sharing is in p2p_demo directory (same level as py scripts). Then run following cmd:

python create_torrent.py myfile.xxx http://localhost:8000/announce myfile.torrent
